...
### R17 — Config-Default für `showRealtimeAiResponse` ist `true` (❌ specified, 2026-09-04)
...
**Ist-Bug (Bug-Hunt #13, 2026-09-04):** nach dem Config-Clean-Break war der Loader-Default `false`
