...
| [0030](0030-statictext-helper-frozen-chatmessageutil.md) | staticText()-Helper im Plugin statt Core-Fix: ChatMessageUtil.toString() droppt SystemMessages (silent-bug) — **superseded by 0056** (Freeze verworfen, Landmine-Fix folgt; ADR bleibt bis zum Fix stehen, dann löschen) | Superseded |
